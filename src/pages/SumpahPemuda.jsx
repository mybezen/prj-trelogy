...
function SumpahPemuda() {
  return (
    ...
    <main className="py-8 mx-auto">
      ...
      <section 
        className="mb-8 px-6 lg:px-12 py-8 rounded-lg w-full bg-cover bg-center bg-no-repeat" 
      ...
      >
        ...
        <p className="mb-6 lg:text-lg leading-relaxed text-white plus-jakarta-sans-semibold text-left">
          Rumusan Kongres Sumpah Pemuda yang diadakan pada tahun 1928 dirumuskan oleh Mohammad Yamin saat Mr. Sunario sedang berpidato di sesi terakhir kongres.
          Yamin menyampaikan gagasan kepada Soegondo bahwa ia memiliki formulasi yang lebih elegan untuk keputusan kongres.
          Setelah mendapat persetujuan dari Soegondo dan peserta lainnya, rumusan tersebut akhirnya dibacakan oleh Soegondo dan dijelaskan lebih lanjut oleh Yamin.
          Rumusan ini kemudian dikenal sebagai Sumpah Pemuda, yang berisi tiga poin utama: pengakuan akan satu tanah air, satu bangsa, dan satu bahasa, yaitu Indonesia.
        </p>
      </section>
