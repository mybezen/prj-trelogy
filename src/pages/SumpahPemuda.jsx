function SumpahPemuda() {
  return (
    <div className="min-h-screen text-white bg-red-800">
      {/* Navigation */}
      <nav className="max-w-md p-2 mx-auto bg-white rounded-full bg-opacity-20">
      ...
      <main className="container px-4 py-8 mx-auto">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4">
            ...
            secarik kertas saat Mr. Sunario berpidato di sesi terakhir kongres.
            Yamin membisikkan kepada Soegondo bahwa ia memiliki formulasi yang
            lebih elegan untuk keputusan kongres. Soegondo setuju dan meminta
            persetujuan dari peserta lain. Sumpah tersebut awalnya dibacakan
            oleh Soegondo dan dijelaskan lebih lanjut oleh Yamin.
          </p>
        ...
        <section className="mb-12">
          ...
          <div className="flex items-start">
            ...
            <div>
              <h3 className="mb-2 text-xl font-bold">Soegondo Djojopoespito</h3>
              <p className="mb-2">
