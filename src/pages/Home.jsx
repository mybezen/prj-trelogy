    ...
    <div className="flex flex-col min-h-screen overflow-hidden text-white bg-red-800">
      ...
      >
        ...
        <div className="px-4 mb-12 text-center" data-aos="fade-up">
          <h1 className="mb-4 text-7xl lostar bg-gradient-to-r from-[#FFF3D0] to-[#FF9495] bg-clip-text text-transparent" data-aos="zoom-in">
            SUMPAH PEMUDA
          </h1>
          <p className="mb-2 text-xl kenarose bg-gradient-to-r from-[#FFF3D0] to-[#FFFFFF] bg-clip-text text-transparent" data-aos="fade-right">
            Jejak Pemuda
          </p>
          <p className="text-lg kenarose" data-aos="fade-left">28 Oktober 1928</p>
        </div>
      </div>

      <section className="w-full p-6 text-red-800 bg-white shadow-md" data-aos="fade-up">
        <div className="text-white -mt-[5rem]">
          <div className="flex items-center justify-center py-3 mx-auto mb-12 rounded-full md:px-6" data-aos="flip-left">
            <AccordionCustomIcon />
          </div>
        </div>

        <div className="flex flex-col-reverse items-start justify-between mx-auto md:flex-row max-w-7xl" data-aos="fade-up">
          <div className="mb-8 md:w-1/2 md:mb-0 md:ml-20" data-aos="zoom-in">
            ...
            <p className="mb-6 text-black plus-jakarta-sans-semibold" data-aos="fade-right">
          ...
          <div className="w-full m-auto md:w-1/2 md:pl-8" data-aos="zoom-in-left">
            <GarudaScene />
          </div>
        </div>
      </section>
      ...
      <section className="flex items-center justify-center pt-5 mx-auto" data-aos="fade-in">
        <ImageSection />
      </section>
