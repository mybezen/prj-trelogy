...
function Home() {
  return (
    <div className="flex flex-col min-h-screen text-white bg-red-800 overflow-hidden">
      <PreLoader />
      <div
      ...
      <section className="w-full p-6 text-red-800 bg-white shadow-md">
        <div className="text-white -mt-[5rem]">
          <div className="flex items-center mx-auto justify-center md:px-6 py-3 mb-12 rounded-full">
            <AccordionCustomIcon />
          </div>
        </div>
