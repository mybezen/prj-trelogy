...
function StrugCarousel() {
  return (
    <div className="overflow-hidden w-full min-h-40">
      ...
      >
        <div className="min-h-50 text-white md:ml-20 text-left md:w-full w-10/12 mx-auto">
          <ul>
        ...
        <div className="min-h-40 text-white md:ml-20 text-left md:w-full w-10/12 mx-auto">
          <ul>
            <li className="flex items-center mb-3">
              <p className="bg-white bg-opacity-80 text-red-800 font-bold text-lg px-3 rounded-full py-0.5 mr-3">
                5
