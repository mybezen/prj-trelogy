    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="w-full md:w-1/2">
          <ul className="list-decimal list-inside kenarose text-3xl space-y-3">
        ...
        <div className="w-full md:w-1/2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {/* Image Item 1 */}
          <div className="relative rounded-lg overflow-hidden group row-span-2 h-[24vh]">
          </div>

          {/* Image Item 2 */}
          <div className="relative rounded-lg overflow-hidden group h-[18vh] w-[8vw]">
            <img
              src={BuildingIcon1}
          ...
          {/* Image Item 3 */}
          <div className="relative rounded-lg overflow-hidden group h-[36vh] w-[12vw]">
            <img
              src={BuildingIcon2}
          ...
          {/* Image Item 4 */}
          <div className="relative rounded-lg overflow-hidden group row-span-2 h-[18vh] w-[8vw] -top-[20vh]">
            <img
              src={BuildingIcon}
